...
public:
    // PriorityQueue에 정수 삽입
    void insert(int value) {
        elements.push_back(value);
        bubbleUp(elements.size() - 1);
    }

    // PriorityQueue에서 최소값을 제거하고 반환
    int pop() {
        if (elements.empty()) {
