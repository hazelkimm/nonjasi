...
class Stack:
    ...
    def __init__(self):
        ...
        self.prev_stack = None   # 이전 연결된 스택
    ...
    def remove_value(self, value):
        ...
        while current:
            if current.data == value:
                ...
                if current == self.top:  # 최상위 노드인 경우
    ...
    def __replace_with_next_stack(self):
        ...
        if self.next_stack:
            self.next_stack.prev_stack = self
