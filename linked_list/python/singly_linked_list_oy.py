...
#    - 두 인덱스의 노드를 스왑하는 함수
# 7. length
#    - 링크드 리스트의 길이를 반환하는 함수
# 8. contains
#    - 링크드 리스트에서 특정 값이 있는지 확인하는 함수
# 9. nth_from_end
#    - 링크드 리스트에서 끝에서 n번째 노드를 반환하는 함수
# 10. get_middle
#     - 링크드 리스트의 중간 지점을 찾는 함수
# 11. reverse
#     - 링크드 리스트를 역순으로 만드는 함수
# 12. reverse_in_groups
#     - 주어진 크기(k)로 리스트를 그룹화하여 각 그룹을 역순으로 만드는 함수
# 13. remove_duplicates
#     - 링크드 리스트에서 중복된 노드를 제거하는 함수
# 14. pop_last
#     - 링크드 리스트에서 마지막 노드를 반환하고 삭제하는 함수
# 15. slice_range
#     - 링크드 리스트에서 특정 범위를 슬라이싱해서 반환하는 함수
# 16. bubble_sort
#     - 버블 정렬로 링크드 리스트를 정렬하는 함수
# 17. insertion_sort
#     - 삽입 정렬로 링크드 리스트를 정렬하는 함수
# 18. selection_sort
#     - 선택 정렬로 링크드 리스트를 정렬하는 함수
# 19. merge_sort
#     - 병합 정렬로 링크드 리스트를 정렬하는 함수
# 20. detect_cycle
#     - 링크드 리스트에 사이클이 있는지 확인하는 함수
# 21. remove_cycle
#     - 링크드 리스트에서 사이클이 존재할 경우, 이를 제거하는 함수
# 22. append_list
#     - 다른 링크드 리스트를 현재 리스트의 끝에 추가하는 함수
# 23. sorted_insert_in_sorted_list
#     - 정렬된 링크드 리스트에 새로운 노드를 올바른 위치에 삽입하는 함수
...
if __name__ == "__main__":
    ...
    print("Middle of the list:", ll.get_middle(ll.head).data)
    ...
    sliced_ll = ll.slice_range(1, 4)
    sliced_ll.print_list()

    print("Deleting node at index 2:")
    ll.delete_at_index(2)
    ll.print_list()

    print("Checking if list contains value 5:", ll.contains(5))

    print("Removing duplicates:")
    ll.remove_duplicates()
    ll.print_list()

    print("Popping last node:", ll.pop_last())
    ll.print_list()

    print("2nd node from the end:", ll.nth_from_end(2))
